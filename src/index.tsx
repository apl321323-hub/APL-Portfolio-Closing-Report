...
function renderSalesPage(el) {
  // 로딩 인디케이터 표시 후 비동기 처리
  el.innerHTML = '<div class="flex items-center justify-center h-64 text-gray-400"><i class="fas fa-spinner fa-spin mr-2"></i>영업리스트 로딩 중...</div>';
  _renderSalesPageAsync(el);
}
async function _renderSalesPageAsync(el) {
